...
:::image type="DotNet Version" source="<./images/dotnetversion.png>" alt-text="<DotNet Version>":::
</p>
:::image type="Docker Tools="<./images/dockerversion.png>" alt-text="<Docker Version>":::
